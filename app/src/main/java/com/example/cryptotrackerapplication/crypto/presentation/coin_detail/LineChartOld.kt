...
fun LineChartOld(
    ...
    Canvas(modifier = modifier
        ...
        val verticalPaddingPx = style.verticalLabelPadding.toPx()
        val horizontalPaddingPx = style.horizontalLabelPadding.toPx()
            ...
            if (showHelperLines) {
                drawLine(
                    color = if (selectedDataPointIndex == index) {
                        style.selectedLineColor
                    } else style.unselectedLineColor, start = Offset(
        ...
        yLabelTextLayoutResults.forEachIndexed { index, result ->
            ...
            if (showHelperLines) {
                drawLine(
                    color = style.unselectedLineColor, start = Offset(
